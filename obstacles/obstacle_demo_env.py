...
class DemoEnv(gym.Env):
    ...
    def __init__(self):
        ...
        for i in range(self.num_obstacles):
            self.obstacles.append(Palette(self.units_x[0], self.units_y[0], image_name="obstacle.png", batch=self.main_batch))
    ...
    def reset(self):
        ...
        env.keyboard_actions = [0 for _ in range(env.num_obstacles + env.num_palettes)]
