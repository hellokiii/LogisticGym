...
class DemoEnv(gym.Env):
    ...
    def reset(self):
        ...
        state = [0, 0, 0, self.units_x[0], self.units_y[0]]
    ...
    def step(self, action):
        ...
        for i in range(self.num_palettes):
            ...
            obs = np.array([on_unit, palette.is_moving, palette.inspected, palette.sprite.x, palette.sprite.y])
...
if __name__ == '__main__':
    ...
    while True:
        ...
        obs, rewards, done, info = env.step(k_action)
        # pyglet.clock.tick()
        # game_window.switch_to()
        # game_window.dispatch_events()
        # game_window.dispatch_event('on_draw')
