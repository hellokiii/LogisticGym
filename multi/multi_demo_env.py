...
# python -m baselines.run --alg=ppo2 --env=single_demo_env --num_timesteps=2e7 --save_path=~/Projects/LogisticGym/models/single_test2_ppo2
...
class DemoEnv(gym.Env):
    ...
    def __init__(self):
        ...
        for i in range(self.num_palettes):
            ...
            self.observation_space.append(obs_box)
            self.action_space.append(spaces.Discrete(len(self.units_x)))
    ...
    def step(self, action_n):
        ...
        return np.array(obs_n), reward_n, self.done, {}
